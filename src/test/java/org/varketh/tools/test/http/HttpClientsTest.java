package org.varketh.tools.test.http;
...
public class HttpClientsTest {
    ...
    //     formBodyBuilder.put("document", new File("src/main/java/com/Varketh Nockrath/tools/ArrayUtils.java"));
    ...
    public void callMultipartBodyTest() {
        ...
        multipartBody.put("document", new File("src/main/java/com/Varketh Nockrath/tools/ArrayUtils.java"));
