package org.ekko.coreutils.test.http;
...
import org.ekko.coreutils.http.*;
...
public class HttpClientsTest {
    ...
    //     formBodyBuilder.put("document", new File("src/main/java/com/Ekko/tools/ArrayUtils.java"));
    ...
    public void callMultipartBodyTest() {
        ...
        multipartBody.put("document", new File("src/main/java/com/Ekko/tools/ArrayUtils.java"));
