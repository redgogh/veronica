package org.varketh.tools.security;

/* -------------------------------------------------------------------------------- *\
|*                                                                                  *|
|*    Copyright (C) 2023 Varketh Nockrath                                                   *|
|*                                                                                  *|
...
import org.varketh.tools.security.codec.Base64Codec;
import org.varketh.tools.security.codec.MD5Codec;
import org.varketh.tools.security.codec.SHA256Codec;
import org.varketh.tools.security.codec.URLCodec;
...
import static org.varketh.tools.string.StringUtils.strlen;
...
public class Codec {
    ...
    /**
     * 生成并返回下一个随机的 AES 密钥，使用 Base64 编码格式表示
     *
