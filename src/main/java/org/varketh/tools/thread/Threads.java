package org.varketh.tools.thread;

import org.varketh.tools.exception.UncheckedThreadException;
...
public class Threads {
    ...
    public static ThreadFactory namedThreadFactory(String prefix, boolean daemon) {
        ...
        return r -> {
            Thread t = new Thread(r, fmt(prefix.concat("-%d"), count.getAndIncrement()));
            t.setDaemon(daemon);
            return t;
        };
    }
