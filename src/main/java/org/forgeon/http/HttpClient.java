...
import org.forgeon.collection.Maps;
...
import static org.forgeon.string.StringUtils.strcheckin;
...
public class HttpClient {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response get(String url) {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response get(String url, QueryArgumentsBuilder builder) {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response get(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response get(String url, RequestConfigure configure, QueryArgumentsBuilder builder) {
        return open("GET", url)
                .configure(configure)
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response post(String url) {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response post(String url, Object body) {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response post(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.forgeon.http.Response post(String url, RequestConfigure configure, Object body) {
     ...
     */
    public org.forgeon.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.forgeon.http.Response newCall(Callback callback) {
     ...
     * 处理响应
     */
    private org.forgeon.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.forgeon.http.Response retval = new org.forgeon.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
