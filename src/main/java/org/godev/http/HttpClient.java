...
import static org.godev.string.StringUtils.strcheckin;
...
public class HttpClient {
     ...
     * @return 响应
     */
    public static org.godev.http.Response get(String url) {
     ...
     * @return 响应
     */
    public static org.godev.http.Response get(String url, QueryArgumentsBuilder builder) {
     ...
     * @return 响应
     */
    public static org.godev.http.Response get(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.godev.http.Response get(String url, RequestConfigure configure, QueryArgumentsBuilder builder) {
        return open("GET", url)
                .configure(configure)
     ...
     * @return 响应
     */
    public static org.godev.http.Response post(String url) {
     ...
     * @return 响应
     */
    public static org.godev.http.Response post(String url, Object body) {
     ...
     * @return 响应
     */
    public static org.godev.http.Response post(String url, RequestConfigure configure) {
     ...
     * @return 响应
     */
    public static org.godev.http.Response post(String url, RequestConfigure configure, Object body) {
     ...
     */
    public org.godev.http.Response newCall() {
        return newCall(null);
    }
     ...
     */
    public org.godev.http.Response newCall(Callback callback) {
     ...
     * 处理响应
     */
    private org.godev.http.Response newCallResponse(okhttp3.Response okResponse) throws IOException {
        /* response */
        org.godev.http.Response retval = new org.godev.http.Response(okResponse.code(), okResponse.headers(), okResponse.body());
